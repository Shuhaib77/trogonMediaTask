      ...
      <div className="bg-violet-700">
        {videoById.map((item, i) => (
          <div className="pl-[30px] pr-[30px] pt-[20px]">
            ...
            <h1 className="pl-[5px] text-yellow-50">{item.title}</h1>
            <div className="bg-violet-400 shadow-md mt-[20px]" onClick={()=>{
                navigate(`/stream/${item.id}`)
            }}>
              <div className="w-[100%] h-[200px]  flex justify-around items-center  mt-[20px] ">
                ...
                <div className="w-[40%] flex flex-col gap-[10px] place-content-center place-items-center text-white  h-[100%] ">
                  ...
                  <h1 className="text-amber-200">vghbjnkml'</h1>
                </div>
