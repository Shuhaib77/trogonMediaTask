            ...
            >
              <div className="w-[30%] h-[100%] grid place-content-center ">
                <div className="bg-violet-300  w-[50px] h-[50px]     rounded-[100%]  ml-[10px]   ">
                  <div className=" w-[50px] sm:[100%] lg:h-[50px] p-[5px] rounded-[100%] bg-violet-500 grid place-content-center  ">
                    {i + 1}
                  </div>
                </div>
              </div>
              <div className="w-[40%] flex flex-col gap-[10px] place-content-center place-items-center text-white  h-[100%] sm:p-[10px] ">
                <h1>{item?.title}</h1>
